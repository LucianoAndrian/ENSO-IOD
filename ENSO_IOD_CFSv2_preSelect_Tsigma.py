"""
Pre-procesamiento Tsigma --> no funca! error en mfopen_dataset debido a la
dimencion S de los archivos de real-time
la solucion cuesta 40gb de RAM o mas. por ahora no es posible probarla en el
servidor...
...
#     xr.concat([jja_anom_82_98_detrend, jja_anom_99_11_detrend], dim='time')
# jja_hindcast_detrend.to_netcdf(out_dir + 'tsigma_aux_hindcast_detrend_jja.nc')
# jja_clim_99_11.to_netcdf(out_dir + 'tsigma_aux_jja_clim_99_11.nc')
...
#
# jas_hindcast_detrend = \
#     xr.concat([jas_anom_82_98_detrend, jas_anom_99_11_detrend], dim='time')
#
# jas_hindcast_detrend.to_netcdf(out_dir + 'tsigma_aux_hindcast_detrend_jas.nc')
# jas_clim_99_11.to_netcdf(out_dir + 'tsigma_aux_jas_clim_99_11.nc')
...
#
# aso_hindcast_detrend = \
#     xr.concat([aso_anom_82_98_detrend, aso_anom_99_11_detrend], dim='time')
#
# aso_hindcast_detrend.to_netcdf(out_dir + 'tsigma_aux_hindcast_detrend_aso.nc')
# aso_clim_99_11.to_netcdf(out_dir + 'tsigma_aux_aso_clim_99_11.nc')
...
son_hindcast_detrend = \
    xr.concat([son_anom_82_98_detrend, son_anom_99_11_detrend], dim='time')

son_hindcast_detrend.to_netcdf(out_dir + 'tsigma_aux_hindcast_detrend_son.nc')
son_clim_99_11.to_netcdf(out_dir + 'tsigma_aux_son_clim_99_11.nc')
...
data = xr.open_mfdataset(files, decode_times=False).sel(
    L=[0.5, 1.5, 2.5, 3.5], M=slice(1,24), Y=slice(20, -70))
data['L'] = [0,1,2,3]
data = data.rename({'X': 'lon', 'Y': 'lat', 'M': 'r', 'S': 'time'})
...
#-------------------------------------------------------------------------------
# jja_clim_99_11 = xr.open_dataset(out_dir + 'tsigma_aux_jja_clim_99_11.nc')
# jas_clim_99_11 = xr.open_dataset(out_dir + 'tsigma_aux_jas_clim_99_11.nc')
# aso_clim_99_11 = xr.open_dataset(out_dir + 'tsigma_aux_aso_clim_99_11.nc')
son_clim_99_11 = xr.open_dataset(out_dir + 'tsigma_aux_son_clim_99_11.nc')

# jja_hindcast_detrend = \
#     xr.open_dataset(out_dir + 'tsigma_aux_hindcast_detrend_jja.nc')
# jas_hindcast_detrend = \
#     xr.open_dataset(out_dir + 'tsigma_aux_hindcast_detrend_jas.nc')
# aso_hindcast_detrend = \
#     xr.open_dataset(out_dir + 'tsigma_aux_hindcast_detrend_aso.nc')
son_hindcast_detrend = \
    xr.open_dataset(out_dir + 'tsigma_aux_hindcast_detrend_son.nc')
...
# save -------------------------------------------------------------------------
# jja_f.to_netcdf(out_dir + 'tsigma_jja.nc')
# jas_f.to_netcdf(out_dir + 'tsigma_jas.nc')
# aso_f.to_netcdf(out_dir + 'tsigma_aso.nc')
son_f.to_netcdf(out_dir + 'tsigma_son.nc')
################################################################################