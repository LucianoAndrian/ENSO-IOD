...
#3rm, para ya separar en estaciones
...
#Tomando climatologia  IODW y IODE
iodw_clim1, iodw_clim2 = TwoClimEnsemble(iodw)
iodw_clim1 = iodw_clim1.load()
iodw_clim2 = iodw_clim2.load()

"""
En ningun caso se encontro tendencia significativa al mirarla en estaciones
Se puede probar con lo comentado
"""
