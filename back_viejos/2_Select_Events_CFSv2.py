...
for m_name in mmonth_seasons_names:
    ...
    for s in sets:
        ...
        for r in range(1, 25):
            ...
            if len(DMI_sim_pos) != len(N34_sim_pos):
                print('Eventos de signo opuesto!')
            ...
            #sim_pos, sim_neg = xrClassifierEvents(sim_events, by_r=False)

            aux_tref = data_tref_s.sel(r=r)
