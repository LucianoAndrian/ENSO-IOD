...
out_dir = '/datos/luciano.andrian/ncfiles/NMME_CFSv2/by_months/DMI_N34_Leads_r/'
...
for ms in mmonth_numbers:
    ...
    dmi_season_r_f.to_netcdf(out_dir + months[ms - 6] + '_DMI_Leads_r_CFSv2.nc')
    n34_season_r_f.to_netcdf(out_dir + months[ms - 6] + '_N34_Leads_r_CFSv2.nc')
