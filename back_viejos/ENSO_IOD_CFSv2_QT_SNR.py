...
out_dir = '/home/luciano.andrian/doc/salidas/ENSO_IOD/Modelos/SNR_CFSv2/QT/'
save=True
dpi=200
# Funciones ############################################################################################################
            ...
            for c in cases:
                ...
                try:
                    ...
                    Plot(aux, levels=scales[v_count], cmap=colormap[v_count],
                         dpi=dpi, step=1,
                         name_fig=v + '_set_QT_' + s_n + '_' + c + '_' + s + '.nc',
                    ...
                    Plot(aux2, levels=scales_sd[v_count], cmap=colormap_sd[v_count],
                         dpi=dpi, step=1,
                         name_fig=v + 'SD_set_QT_' + s_n + '_' + c + '_' + s + '.nc',
                    ...
                    Plot(snr, levels=scales_snr[v_count], cmap=cbar_snr,
                         dpi=dpi, step=1,
                         name_fig=v + 'SNR_set_QT_' + s_n + '_' + c + '_' + s + '.nc',
