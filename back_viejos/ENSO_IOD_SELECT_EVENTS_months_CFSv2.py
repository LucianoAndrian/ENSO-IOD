...
import numpy as np
########################################################################################################################
dates_dir = '/datos/luciano.andrian/ncfiles/NMME_CFSv2/by_months/DMI_N34_Leads_r/'
dir_leads = '/datos/luciano.andrian/ncfiles/NMME_CFSv2/by_months/'
out_dir = '/pikachu/datos/luciano.andrian/cases/by_months/'
...
def ConcatEvent(xr_original, xr_to_concat, dim='time'):
    ...
    return xr_concat
########################################################################################################################
mmonth_seasons_names = [0,1,2,3,4,5] #son las de abajo...
...
for m_name in mmonth_seasons_names:
    print(months[m_name])
    data_dmi_s = xr.open_dataset(dates_dir + months[m_name] + '_DMI_Leads_r_CFSv2.nc')
    data_n34_s = xr.open_dataset(dates_dir + months[m_name] + '_N34_Leads_r_CFSv2.nc')
    data_tref_s = xr.open_dataset(dir_leads + months[m_name] + '_tref_Leads_r_CFSv2.nc')
    data_prec_s = xr.open_dataset(dir_leads + months[m_name] + '_prec_Leads_r_CFSv2.nc')

    for s in sets:
        print('Set: ' + str(s))
        l = np.arange(len(s))
        ms = mmonth_numbers[m_name]
        ...
        print('saving...')
        data_dmi_pos_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_pos.nc')
        data_dmi_neg_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_neg.nc')
        data_dmi_un_pos_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_un_pos.nc')
        data_dmi_un_neg_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_un_neg.nc')
        data_n34_pos_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_pos.nc')
        data_n34_neg_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_neg.nc')
        data_n34_un_pos_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_un_pos.nc')
        data_n34_un_neg_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_un_neg.nc')
        data_sim_pos_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_pos.nc')
        data_sim_neg_f_tref.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_neg.nc')

        data_dmi_pos_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_pos.nc')
        data_dmi_neg_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_neg.nc')
        data_dmi_un_pos_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_un_pos.nc')
        data_dmi_un_neg_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_DMI_un_neg.nc')
        data_n34_pos_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_pos.nc')
        data_n34_neg_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_neg.nc')
        data_n34_un_pos_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_un_pos.nc')
        data_n34_un_neg_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_N34_un_neg.nc')
        data_sim_pos_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_pos.nc')
        data_sim_neg_f_prec.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_neg.nc')

        if len(DMI_sim_pos_N34_neg) != 0:
            data_sim_DMIpos_N34neg_f_prec.to_netcdf(
                out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_DMIpos_N34neg.nc')

            data_sim_DMIpos_N34neg_f_tref.to_netcdf(
                out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_DMIpos_N34neg.nc')

        if len(DMI_sim_neg_N34_pos) != 0:
            data_sim_DMIneg_N34pos_f_prec.to_netcdf(
                out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_DMIneg_N34pos.nc')

            data_sim_DMIneg_N34pos_f_tref.to_netcdf(
                out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_sim_DMIneg_N34pos.nc')

        neutro_tref_f.to_netcdf(out_dir + 'tref_' + months[m_name] + '_Set' + str(s[-1]) + '_NEUTRO.nc')
        neutro_prec_f.to_netcdf(out_dir + 'prec_' + months[m_name] + '_Set' + str(s[-1]) + '_NEUTRO.nc')