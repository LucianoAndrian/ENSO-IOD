...
for m_name in mmonth_seasons_names:
    ...
    for s in sets:
        ...
        print('saving...')
        data_dmi_pos_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_pos.nc')
        data_dmi_neg_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_neg.nc')
        data_dmi_un_pos_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_un_pos.nc')
        data_dmi_un_neg_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_un_neg.nc')
        data_n34_pos_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_pos.nc')
        data_n34_neg_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_neg.nc')
        data_n34_un_pos_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_un_pos.nc')
        data_n34_un_neg_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_un_neg.nc')
        data_sim_pos_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_pos.nc')
        data_sim_neg_f_tref.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_neg.nc')

        data_dmi_pos_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_pos.nc')
        data_dmi_neg_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_neg.nc')
        data_dmi_un_pos_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_un_pos.nc')
        data_dmi_un_neg_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_DMI_un_neg.nc')
        data_n34_pos_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_pos.nc')
        data_n34_neg_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_neg.nc')
        data_n34_un_pos_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_un_pos.nc')
        data_n34_un_neg_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_N34_un_neg.nc')
        data_sim_pos_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_pos.nc')
        data_sim_neg_f_prec.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_neg.nc')

        if len(DMI_sim_pos_N34_neg) != 0:
            data_sim_DMIpos_N34neg_f_prec.to_netcdf(
                out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_DMIpos_N34neg.nc')

            data_sim_DMIpos_N34neg_f_tref.to_netcdf(
                out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_DMIpos_N34neg.nc')

        if len(DMI_sim_neg_N34_pos) != 0:
            data_sim_DMIneg_N34pos_f_prec.to_netcdf(
                out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_DMIneg_N34pos.nc')

            data_sim_DMIneg_N34pos_f_tref.to_netcdf(
                out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_sim_DMIneg_N34pos.nc')

        neutro_tref_f.to_netcdf(out_dir + 'tref_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_NEUTRO.nc')
        neutro_prec_f.to_netcdf(out_dir + 'prec_QT' + seasons[m_name] + '_Set' + str(s[-1]) + '_NEUTRO.nc')