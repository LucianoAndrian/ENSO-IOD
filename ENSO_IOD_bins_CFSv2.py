...
def Plot3Dbins(bin_d, bin_n, title, name_fig, cmap='BrBG', lims=50):
    import matplotlib.pyplot as plt
    ...
    cmap = cm.get_cmap(cmap)  # Get desired colormap - you can change this!
    ...
    fig = plt.figure(dpi=400, figsize=plt.figaspect(0.5))
    ...
    ax.view_init(25, 40 - 180)
    ax.plot(x_r, y_r, -1*lims - 0.5, zdir='z', c='k', zorder=0)
    ax.plot(y_r, x_r, -1*lims - 0.5, zdir='z', c='k', zorder=0)
    ax.plot(np.zeros_like(y_r) + 3.5, np.zeros_like(y_r), np.linspace(-1*lims, lims, 13), zdir='z', c='k', zorder=0)
    ax.plot(np.zeros_like(y_r), np.zeros_like(y_r) + 3.5, np.linspace(-1*lims, lims, 13), zdir='z', c='k', zorder=0)
    ax.set_ylim(-3.5, 3.5)
    ax.set_xlim(-3.5, 3.5)
    ...
    ax1.bar3d(X.ravel(), Y.ravel(), Z0.ravel(), 0.5, 0.5, Z.ravel(), color=rgba, alpha=1, zorder=4)
    ax1.set_zlim(lims, -1*lims)
    ax1.view_init(25, 40)
    ax1.plot(x_r, y_r, lims + 0.5, zdir='z', c='k', zorder=0)
    ax1.plot(y_r, x_r, lims + 0.5, zdir='z', c='k', zorder=0)
    ax1.plot(y_r - 3.5, y_r, np.linspace(-1*lims, lims, 13), zdir='z', c='k', zorder=0)
    ax1.plot(y_r, y_r - 3.5, np.linspace(-1*lims, lims, 13), zdir='z', c='k', zorder=0)
    ax1.set_ylim(-3.5, 3.5)
    ax1.set_xlim(-3.5, 3.5)
    ax1.set_xlabel('Niño3.4 - SST index (of std)', fontsize=10)
    ax1.set_ylabel('DMI - SST index (of std)', fontsize=10)
...
for m_name in mmonth_seasons_names:
    ...
    for s in sets:
        ...
        # Plot3Dbins(bin_d, bin_n, 'Prec - S-SESA - ' + seasons[m_name] ,
        #            '3DPrec_S_SESA_' + seasons[m_name])
        ...
        # Plot3Dbins(bin_d, bin_n, 'Prec - S-SESA_exp - ' + seasons[m_name] ,
        #            '3DPrec_S_SESA_exp' + seasons[m_name])
        ...
        # Plot3Dbins(bin_d, bin_n, 'Prec - N-SESA - ' + seasons[m_name] ,
        #            '3DPrec_N_SESA' + seasons[m_name])
        ...
        # Plot3Dbins(bin_d, bin_n, 'Prec - Andes_Chile - ' + seasons[m_name] ,
        #            '3DPrec_Andes_Chile' + seasons[m_name])
        ...
        # Plot3Dbins(bin_d, bin_n, 'Prec - C-Brazil - ' + seasons[m_name] ,
        #            '3DPrec_C_Brazil' + seasons[m_name])
        ...
        #
        # Plot3Dbins(bin_d, bin_n, 'Prec - E-Patagonia - ' + seasons[m_name] ,
        #            '3DPrec_E_Patagonia' + seasons[m_name])
        ...
        # Plot3Dbins(bin_d, bin_n, 'Tref - S-SESA - ' + seasons[m_name] ,
        #            '3DTref-S_SESA_' + seasons[m_name], lims=2, cmap='RdBu_r')

        bin_n, bin_n_err, bin_n_len, bin_d, bin_d_err, bin_d_len = \
            Compute(S_SESA_exp_t, dmi_b0, dmi_b1, dmi_b2, dmi_b3, dmi_b4, dmi_b5, dmi_b6
                    , dmi_b_1, dmi_b_2, dmi_b_3, dmi_b_4, dmi_b_5, dmi_b_6,
                    n34_b0, n34_b1, n34_b2, n34_b3, n34_b4, n34_b5, n34_b6,
                    n34_b_1, n34_b_2, n34_b_3, n34_b_4, n34_b_5, n34_b_6)
        ...
        #
        # Plot3Dbins(bin_d, bin_n, 'Tref - S-SESA_exp - ' + seasons[m_name] ,
        #            '3DTref-S_SESA_exp_' + seasons[m_name], lims=2, cmap='RdBu_r')
        ...
        # Plot3Dbins(bin_d, bin_n, 'Tref - N-SESA - ' + seasons[m_name] ,
        #            '3DTref-N_SESA_' + seasons[m_name], lims=2, cmap='RdBu_r')
        ...
        # Plot3Dbins(bin_d, bin_n, 'Tref - Andes_Chile - ' + seasons[m_name] ,
        #            '3DTref-ANDES_CHILE_' + seasons[m_name], lims=2, cmap='RdBu_r')
        ...
        # Plot3Dbins(bin_d, bin_n, 'Tref - C_Brazil - ' + seasons[m_name] ,
        #            '3DTref-C_Brazil_' + seasons[m_name], lims=2, cmap='RdBu_r')
        ...
        # Plot3Dbins(bin_d, bin_n, 'Tref - E-Patagonia - ' + seasons[m_name] ,
        #            '3DTref-E_Pataogina_' + seasons[m_name], lims=2, cmap='RdBu_r')
