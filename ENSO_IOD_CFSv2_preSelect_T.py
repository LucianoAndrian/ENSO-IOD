"""
Pre-procesamiento T --> no funca! error en mfopen_dataset debido a la dimencion
 S de los archivos de real-time
...
def Detrend_Seasons(season_anom_1982_1998, season_anom_1999_2011,
    ...
    for l in [0,1,2,3]:
        ...
        aux_trend =\
            xr.polyval(aux_season_anom_1982_1998['time'],
    ...
    # 1999-2011
        ...
        aux_trend = \
            xr.polyval(aux_season_anom_1999_2011['time'],
                       aux.tref_polyfit_coefficients)
        if l==0:
