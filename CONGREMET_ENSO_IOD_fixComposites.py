...
out_dir_w_sig = '/home/luciano.andrian/doc/salidas/ENSO_IOD/CONGREMET/'
out_dir_no_sig = '/home/luciano.andrian/doc/salidas/ENSO_IOD/CONGREMET/'
...
for v in variables_t_p:
    ...
    for c in cases:
        ...
        for s in seasons:
            ...
            Plot(comp=comp1*mask, levels=scales[v_count_sc], cmap = cmap_t_pp[v_count], step1=1, contour1=False,
                 ...
                 dpi=dpi, save=save, comp_sig=sig*mask_sig, color_sig='k')
    ...
    for c in cases:
        ...
        for s in seasons:
            ...
            Plot(comp=comp1, levels=scales[v_count], cmap=cbar_t, step1=1,
                 ...
                 title='HGT200' + '\n' + title_case[c_count] + '\n' + s + ' - Events: ' + str(num_case),
                 name_fig='HGT200_'  + s + '_' + cases[c_count] + '_mer_d_w_NSA',
